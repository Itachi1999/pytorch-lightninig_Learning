# The Torchmetrics is going to be used in conjunction to Lightning Module, also going to create our own metric (similar to accuracy)
# But this method is very slow which we will see in the Profiler Section
